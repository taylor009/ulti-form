...
const EXAMPLE_DATA: EmployeeTableItem[] = [
  {name: 'John', email: 'john@example.com', phone: '1-303-111-1111', website: 'example.com'},
  {name: 'Bob', email: 'bob@test.com', phone: '1-222-2222-2222', website: 'test.com'},
  {name: 'Sam', email: 'sam@google.com', phone: '1-333-3333-3333', website: 'google.com'}
];
